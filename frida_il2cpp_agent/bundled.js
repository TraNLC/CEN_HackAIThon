      ...
      function initBot() {
        ...
        Il2Cpp.perform(() => {
          ...
          try {
            ...
            console.log("T\xECm Class game.ui.NpcDialogPc...");
            const NpcDialogPc = image.class("game.ui.NpcDialogPc");
            console.log(`\u0110\xE3 t\xECm th\u1EA5y NpcDialogPc: ${NpcDialogPc.handle}`);
            const openMethod = NpcDialogPc.method("Open");
            console.log(`\u0110\xE3 t\xECm th\u1EA5y h\xE0m Open(): ${openMethod.virtualAddress}`);
            let dialogInstance = null;
            openMethod.implementation = function() {
              console.log(`[+] H\xE0m Open() c\u1EE7a NpcDialogPc v\u1EEBa \u0111\u01B0\u1EE3c game g\u1ECDi! (Instance: ${this.handle})`);
              dialogInstance = this;
              return this.method("Open").invoke();
            };
            console.log("\u0110\xE3 \u0111\u1EB7t Hook v\xE0o NpcDialogPc.Open() th\xE0nh c\xF4ng!");
            rpc.exports = {
              remoteOpenDialog: function() {
                if (dialogInstance) {
                  console.log("\u0110ang g\u1ECDi h\xE0m Open() t\u1EEB xa...");
                  Il2Cpp.scheduleOnMainThread(() => {
                    dialogInstance.method("Open").invoke();
                    console.log("\u0110\xE3 g\u1EEDi l\u1EC7nh Open() th\xE0nh c\xF4ng!");
                  });
                  return "SUCCESS";
                } else {
                  return "ERROR: Ch\u01B0a b\u1EAFt \u0111\u01B0\u1EE3c Instance c\u1EE7a NpcDialogPc. H\xE3y click th\u1EE7 c\xF4ng v\xE0o D\xE3 T\u1EA9u 1 l\u1EA7n \u0111\u1EC3 Tool b\u1EAFt \u0111\u1ED1i t\u01B0\u1EE3ng!";
                }
              }
            };
            console.log("Bot IL2CPP \u0111\xE3 s\u1EB5n s\xE0ng!");
          } catch (e) {
