...
- [ ] **Xây dựng State Machine độc lập:** Mỗi Acc sẽ có một não bộ riêng ghi nhớ: Tọa độ, HP/MP, Danh sách quái quanh mình.
- [ ] **Packet Forging:** Viết các hàm giả lập gói tin gửi lên Server (Move, Loot, UseSkill, NpcClick).
